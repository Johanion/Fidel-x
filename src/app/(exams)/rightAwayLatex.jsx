...
const RightAway = () => {
  ...
  async function handleOpenModal() {
    ...
    try {
      const result = await IntelligentRequest(prompt, missedQuestions);
      setAiText(result);
    } catch (e) {
  ...
  // },[])
  console.log("i am in latexxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
    ...
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
        ...
        >
          ...
          {/* Artifical intelligence analysis pop up view */}
                ...
                options={{
                  ...
                  headerLeft: () => (
                    ...
                    >
                      ...
                      >
                        {showTime ? tableName : formatTime(timeLeft)}
                      </Text>
                    </View>
                  ),
                      ...
                      <View style={styles.quizBox}>
                        <View style={styles.question}>
                          <Text style={{ fontFamily: "Poppins-Medium" }}>
                            {questionIndex + 1}.{" "}
                            <MathRenderer latexContent={item.question} />
                          </Text>
                        </View>
                        {item.options.map((option, optionIndex) => (
                          ...
                          >
                            ...
                            >
                              <Text style={{ fontFamily: "Poppins-Medium" }}>
                                <MathRenderer latexContent={option} />
                              </Text>
                            </TouchableOpacity>
                          </View>
                        ))}
                        ...
                        {selectedOptions[questionIndex] !== undefined && (
                          <>
                            ...
                            {expandedQuestions[questionIndex] && (
                              <View style={{ flex: 1 }}>
                                <MathRenderer latexContent={item.explanation} />
                              </View>
                            )}
                          </>
                        )}
